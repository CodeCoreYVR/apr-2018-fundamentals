...
const filter = function(numArr, fn) {
...
const stretchArray = [-1, 6, -3, 4, 1, 'Carmen', -50, 88, 'Jennie']

// ES6 Built in filter function
stretchArray.filter(function(element) {
  return isPositive(element)
});
